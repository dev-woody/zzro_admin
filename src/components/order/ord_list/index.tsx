...
const OrdListBlock = styled(BaseBlock)``;
...
const OrdList = () => {
  const goodsColumns = [
    ...
    {
      title: "환불차감",
      dataIndex: "ordList_diff",
    },
    {
      title: "확정환불금액",
      dataIndex: "ordList_price",
    },
    {
      title: "현금환불",
      dataIndex: "cash_ordList",
    },
    {
      title: "포인트환불",
      dataIndex: "point_ordList",
    },
    {
      title: "반품상태",
    ...
    {
      title: "환불상태",
      dataIndex: "ordList_status",
    },
    {
      title: "환불일시",
      dataIndex: "ordList_date",
    },
  ];
